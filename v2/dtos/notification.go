...
type Notification struct {
	...
	Category           string    `json:"categories,omitempty" validate:"required_without=Labels,oneof='SECURITY' 'SW_HEALTH' 'HW_HEALTH'"`
	Labels             []string  `json:"labels,omitempty" validate:"required_without=Category,gt=0,dive,edgex-dto-none-empty-string,edgex-dto-rfc3986-unreserved-chars"`
